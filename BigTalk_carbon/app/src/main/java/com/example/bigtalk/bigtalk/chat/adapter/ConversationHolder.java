package com.example.bigtalk.bigtalk.chat.adapter;
...
/**
 * Created by Jacqueline on 2018/2/5.
 */
...
public class ConversationHolder extends BaseViewHolder {
    ...
    public void bindData(Object o) {
        ...
        //会话图标
        ViewUtil.setAvatar(conversation.getConversationIcon(), R.mipmap.head2, iv_recent_avatar);
        //会话标题
